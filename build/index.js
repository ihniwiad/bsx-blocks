...
registerBlockType('bsx-blocks/lazy-img', {
  ...
  edit: function edit(props) {
    ...
    var hasValidImg = imgId && typeof calcImgSizes !== 'undefined' && typeof calcImgSizes[imgSizeIndex] !== 'undefined';
    ...
    var width = hasValidImg && !!displayedWidth ? displayedWidth : calcImgSizes[imgSizeIndex].width;
    var height = hasValidImg && !!displayedHeight ? displayedHeight : calcImgSizes[imgSizeIndex].height;
    var sizes = '(max-width: ' + width + 'px) 100vw, ' + width + 'px';
  ...
  save: function save(props) {
    ...
    var hasValidImg = typeof calcImgSizes !== 'undefined' && typeof calcImgSizes[imgSizeIndex] !== 'undefined';
