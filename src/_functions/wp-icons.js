...
export function svgIcon( iconKey ) {
    ...
    switch( iconKey ) {
        ...
        case 'slider':
            icon = (
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" role="img" focusable="false">
                  <path d="M10,16c-0.55,0-1,0.45-1,1s0.45,1,1,1c0.55,0,1-0.45,1-1S10.55,16,10,16z M7,16c-0.55,0-1,0.45-1,1s0.45,1,1,1
                    c0.55,0,1-0.45,1-1S7.55,16,7,16z M13,16c-0.55,0-1,0.45-1,1s0.45,1,1,1s1-0.45,1-1S13.55,16,13,16z M4,15h12V5H4V15z M1,15h2V5H1
                    V15z M17,5v10h2V5H17z"/>
                </svg>
            );
            break;
