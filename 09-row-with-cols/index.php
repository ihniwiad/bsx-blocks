 ...
 */
add_action( 'init', 'bsx_blocks_row_with_cols_load_textdomain' );

function bsx_blocks_row_with_cols_load_textdomain() {
...
function bsx_blocks_row_with_cols_register_block() {
    ...
    if ( function_exists( 'wp_set_script_translations' ) ) {
         ...
         */
        wp_set_script_translations( 'bsx-blocks-row-with-cols', 'bsx-blocks' );
    }
