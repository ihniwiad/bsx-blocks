 ...
 * Description: Container for BSX (a Bootstrap based style & js package) WordPress blocks.
 * Version: 1.0.0
 * Author: ihniwiad
 *
 * @package bsx-blocks
 ...
 */
add_action( 'init', 'bsx_blocks_container_load_textdomain' );

function bsx_blocks_container_load_textdomain() {
...
function bsx_blocks_container_register_block() {
    ...
    register_block_type( 'bsx-blocks/container', array(
        ...
        'editor_script' => 'bsx-blocks-container',
    ) );
    ...
    if ( function_exists( 'wp_set_script_translations' ) ) {
         ...
         */
        wp_set_script_translations( 'bsx-blocks-container', 'bsx-blocks' );
    }
