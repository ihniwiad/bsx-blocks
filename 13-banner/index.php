 ...
 */
add_action( 'init', 'bsx_blocks_banner_load_textdomain' );

function bsx_blocks_banner_load_textdomain() {
...
function bsx_blocks_banner_register_block() {
    ...
    register_block_type( 'bsx-blocks/banner', array(
        ...
        'editor_script' => 'bsx-blocks-banner',
    ) );
    ...
    if ( function_exists( 'wp_set_script_translations' ) ) {
         ...
         */
        wp_set_script_translations( 'bsx-blocks-banner', 'bsx-blocks' );
    }
